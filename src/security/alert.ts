...
export const createSecurityAlert = async (params: SecurityAlertParams): Promise<void> => {
  ...
  const body = `## 🚨 Security Alert: Prompt Injection Attempts Detected
...
export const sendWebhookAlert = async (params: SecurityAlertParams): Promise<void> => {
  ...
  const payload = {
    text: `🚨 Security Alert: Prompt injection attempts detected`,
    blocks: [
      {
        type: 'header',
        text: {
          type: 'plain_text',
          text: '🚨 Security Alert: Prompt Injection Detected',
        },
      },
      {
        type: 'section',
