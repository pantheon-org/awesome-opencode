 ...
 *
 * Usage:
 *   bun run src/reporting/security-analysis/generate-report.ts [--days=7] [--output=report.md]
 */
 ...
 */
export const generateSecurityReport = (days: number): string => {
...
const main = async () => {
  ...
  const markdown = generateSecurityReport(days);
